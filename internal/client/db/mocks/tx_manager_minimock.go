...
//go:generate minimock -i github.com/Mobo140/microservices/chat/internal/client/db.TxManager -o tx_manager_minimock.go -n TxManagerMock -p mocks
...
import (
	...
	mm_db "github.com/Mobo140/microservices/chat/internal/client/db"
