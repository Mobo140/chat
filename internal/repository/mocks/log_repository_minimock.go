...
//go:generate minimock -i github.com/Mobo140/microservices/chat/internal/repository.LogRepository -o log_repository_minimock.go -n LogRepositoryMock -p mocks
